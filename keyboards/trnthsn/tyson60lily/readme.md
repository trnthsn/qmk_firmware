...
![tyson60lily](https://i.imgur.com/uS2Okww.png)
...
* Hardware Supported: STM32, tyson60lily
* Hardware Availability: [ThanhSon.Mech](https://www.facebook.com/ThanhSon.mech)

Make example for this keyboard (after setting up your build environment):

    make trnthsn/tyson60lily/stm32f103:default

Flashing example for this keyboard:

    make trnthsn/tyson60lily/stm32f103:default:flash
